...
// shared_ptr : 객체에 대한 소유권 있음. 
//				sp 객체가 살아 있는 동안 항상 객체는 파괴 안됨.
//				-> 연산자 재정의 되어 있음. 멤버 함수 접근 가능

// weak_ptr : 객체에 대한 소유권 없음
//			  wp 객체가 살아 있는 동안 항상에도 객체는 파괴 될수 있다.
//			  -> 연산자 재정의 안되어 있음. 객체의 멤버 함수 접근 안됨